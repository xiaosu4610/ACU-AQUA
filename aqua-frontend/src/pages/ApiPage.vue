...
<template>
  ...
  "usage": { ... }                 // 用量统计（本站免费，仅供参考）
        ...
        <section id="a-billing" class="card sec">
          ...
          <p class="desc">先把结论说清楚：<b>本站绝大多数模型完全免费，且会一直免费</b>。其中 <code>acu/</code> 前缀为<b>众筹公共模型</b>——任何密钥都能调，按官方原版定价从站点公共额度扣费、个人余额分文不动。真正用余额付费的只有<b>官方自营收费系列</b>——统一使用 <code>aqua/</code> 前缀，采用<b>按次计费</b>（控制台创建密钥时选择「免费 + 收费」分组即可调用）。</p>
          <h3>哪些免费？——除它之外全部免费</h3>
          <ul class="tips">
