    ...
    <div class="fade-up">
      ...
      <div v-show="view === 'keys'">
        ...
        <div class="card mt16">
          ...
          <p class="dim mt8">acu/ 前缀为<router-link to="/pool">众筹公共模型</router-link>——任何分组密钥都可调用，按<b>官方原版定价</b>从站点额度扣费（充值翻倍到账），个人余额不受影响。</p>
      ...
      <div v-show="view === 'topup'">
        <div class="banner warn">
          ...
          <span>在线充值支付金额 <b>100% 全额到账</b>（渠道手续费由本站承担）；充值余额用于收费模型（aqua/ 前缀）扣费，免费模型不受影响。acu/ 众筹公共模型扣<b>站点额度</b>不动余额——想为公共算力扩容请到 <router-link to="/pool">众筹池充值</router-link>（充 1 元 = 2 元站点额度）。</span>
        </div>
