...
.hint-line { font-size: 12.5px; color: #f87171; margin: 8px 0 0; display: flex; align-items: center; gap: 5px; }
...
.key-time { color: var(--muted, #8a94a6); font-size: 11.5px; margin-left: auto; white-space: nowrap; }
